...
import { Phone, Users, Trash2, Plus, BarChart2, PieChart, Copy } from 'lucide-react';
import { getCampaigns, deleteCampaign, Campaign, addCampaign, getContacts, addContacts } from '../utils/db';
...
const CampaignList: React.FC = () => {
  ...
  const handleDuplicate = async (event: React.MouseEvent, campaign: Campaign) => {
    event.stopPropagation();
              ...
              <div className="bg-gray-50 px-6 py-4 flex justify-between items-center">
                ...
                <button
                  ...
                  className={`text-purple-600 hover:text-purple-800 flex items-center ${
                    duplicating === campaign.id ? 'opacity-50 cursor-not-allowed' : ''
                  }`}
